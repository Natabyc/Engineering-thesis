...
profile_name = "DoS_protect" #add suffix with attack name to know which protection is enabled
policy_name = "DoS_protect"
enable_synflood = 'yes' #Syn flood protection was used in initial testing
enable_udpflood = 'no'
enable_icmpflood = 'no'
alarm_rate = '100'
activate_rate = '1'
